    ...
    stages {
        ...
        stage('Test') {
            ...
            post {
                ...
                stage('Robot') {
            steps {
                sh 'robot --variable BROWSER:headlesschrome -d spring-petclinic-angular/src/test/automation/Results spring-petclinic-angular/src/test/automation/Tests'
            }
            post {
                always {
                    script {
                        step(
                            [
                                ...
                                outputPath              :   'spring-petclinic-angular/src/test/automation/Results',
